...
public class Profesor extends Empleado {
    ...
    public Profesor(String departamento, String nombre, String apellidos, String numeroIdentificacion, String estadoCivil, int yearIncorporacion) {
        super(nombre, apellidos, numeroIdentificacion, estadoCivil, yearIncorporacion);
        this.departamento = departamento;
    }

    public Profesor(String departamento, String nombre, String apellidos, String numeroIdentificacion, String estadoCivil, int yearIncorporacion, int numeroDespacho) {
        super(nombre, apellidos, numeroIdentificacion, estadoCivil, yearIncorporacion, numeroDespacho);
        this.departamento = departamento;
    }

    public Profesor(String departamento, String nombre, String apellidos, String numeroIdentificacion, String estadoCivil) {
